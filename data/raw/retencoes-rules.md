# Regras legais das retenções na fonte (IRRF, CSRF e INSS) e do local devido do ISS

**Compilado em:** 02/09/2026
**Finalidade:** servir de base normativa para classificar cada um dos 205 subitens da lista de serviços anexa à LC 116/2003 (arquivo `data/raw/lc116-lista-completa.json`) quanto a IRRF, CSRF, INSS e local devido do ISS.
...
## 1. IRRF de 1,5% — serviços profissionais (RIR/2018, art. 714)

Confiança: **ALTA** — transcrito do texto consolidado do Planalto (fonte A).
...
### 1.2 § 1º — a lista taxativa (40 incisos)
...
### 1.4 As quatro exceções literais dentro da lista

São os únicos pontos em que o próprio § 1º restringe o alcance. Devem ser reproduzidos com fidelidade em qualquer nota do site:

| Inciso | Serviço | Exceção literal |
|---|---|---|
| I | administração de bens ou negócios em geral | **exceto** consórcios ou fundos mútuos para aquisição de bens |
| VI | assessoria e consultoria técnica | **exceto** serviço de assistência técnica prestado a terceiros e concernente a ramo de indústria ou comércio explorado pelo prestador do serviço |
| XVII | engenharia | **exceto** construção de estradas, pontes, prédios e obras assemelhadas |
...
(São quatro exceções, contando o inciso I. Não há outras no § 1º.)

### 1.5 Artigos vizinhos relevantes
...
## 2. IRRF de 1% — limpeza, conservação, segurança, vigilância e locação de mão de obra (RIR/2018, art. 716)

Confiança: **ALTA** — transcrito do texto consolidado do Planalto (fonte A).

Rubrica oficial da Seção no RIR/2018: *"Serviços de limpeza, conservação, segurança, vigilância e locação de mão de obra"*.
...
**Regra de decisão para classificar a alíquota do IRRF:**

1. O serviço está em algum dos 40 incisos do art. 714, § 1º? → **1,5%**.
2. Não está, mas é limpeza, conservação, segurança, vigilância ou locação de mão de obra? → **1%** (art. 716).
3. Nenhum dos dois? → **sem retenção de IRRF pela natureza da atividade**.

Não existe cumulação: as listas dos arts. 714 e 716 são disjuntas por construção (limpeza, conservação, segurança e vigilância não constam do § 1º do art. 714).
...
**Decomposição do caput em 13 hipóteses** (é assim que a lista deve ser lida na classificação):
...
13. **serviços profissionais** (remissão à lista do RIR — ver 3.3)

### 3.2 Art. 31 — alíquota e limite de dispensa

> **Art. 31.** O valor da CSLL, da COFINS e da contribuição para o PIS/PASEP, de que trata o art. 30, será determinado mediante a aplicação, sobre o montante a ser pago, do percentual de 4,65% (quatro inteiros e sessenta e cinco centésimos por cento), correspondente à soma das alíquotas de 1% (um por cento), 3% (três por cento) e 0,65% (sessenta e cinco centésimos por cento), respectivamente.
>
> **§ 1º** As alíquotas de 0,65% (sessenta e cinco centésimos por cento) e 3% (três por cento) aplicam-se inclusive na hipótese de a prestadora do serviço enquadrar-se no regime de não-cumulatividade na cobrança da contribuição para o PIS/PASEP e da COFINS. *(Vide Lei Complementar nº 214, de 2025) Produção de efeitos*
>
...
>
> **§ 4º** *(Revogado). (Redação dada pela Lei nº 13.137, de 2015)*

🚨 **ARMADILHA CRÍTICA — o limite de R$ 5.000,00 NÃO existe mais.**
A redação **original** do § 3º (dada pela Lei nº 10.925/2004) dispensava a retenção "para pagamentos de valor igual ou inferior a R$ 5.000,00", e o § 4º mandava somar os pagamentos do mês. **A Lei nº 13.137/2015 substituiu integralmente o § 3º pelo limite de R$ 10,00 e REVOGOU o § 4º.** A IN SRF 459/2004 (§§ 3º, 4º e 5º do art. 1º) **nunca foi atualizada** e continua repetindo o texto revogado de R$ 5.000,00. Um enorme volume de material contábil na internet — e a amostra anterior deste projeto, em `data/retencoes.json`, subitem 17.14 — reproduz o limite errado. **Use R$ 10,00.**

### 3.3 Art. 32 — hipóteses de não exigência
...
>
> *(Redação original dos incisos I e II, hoje substituída: "I - Itaipu Binacional; II - empresas estrangeiras de transporte de cargas ou passageiros".)*
>
...
> **I** – a título de transporte internacional de valores efetuados por empresa nacional; *(Redação dada pela Lei nº 10.865, de 2004)*
...
>
> **§ 3º** É dispensada a retenção para pagamento de valor igual ou inferior a R$ 5.000,00 (cinco mil reais). ⚠️ **[TEXTO SUPERADO — ver 3.2]**
>
> **§ 4º** Ocorrendo mais de um pagamento no mesmo mês à mesma pessoa jurídica, a cada pagamento deverá ser:
> **I** - efetuada a soma de todos os valores pagos no mês;
> **II** - calculado o valor a ser retido sobre o montante obtido na forma do inciso I deste parágrafo, desde que este ultrapasse o limite de que trata o § 3º, devendo ser deduzidos os valores retidos anteriormente no mesmo mês; ⚠️ **[TEXTO SUPERADO — ver 3.2]**
>
...
>
> **§ 6º** Não estão obrigadas a efetuar a retenção a que se refere o caput, as pessoas jurídicas optantes pelo Regime Especial Unificado de Arrecadação de Tributos e Contribuições devidos pelas Microempresas e Empresas de Pequeno Porte (Simples Nacional). *(Redação dada ao parágrafo pela Instrução Normativa RFB nº 1.151, de 03.05.2011, DOU 04.05.2011)*
>
...
> **II** - aos pagamentos efetuados pelos fundos de investimento autorizados pela Comissão de Valores Mobiliários. *(NR) (Redação dada ao parágrafo pela Instrução Normativa RFB nº 1.151, de 03.05.2011, DOU 04.05.2011)*
>
...
⚠️ **Remissão a norma revogada dentro da própria IN.** O § 2º, IV, remete ao *"§ 1º do art. 647 do Decreto nº 3.000, de 26 de março de 1999 (RIR/1999)"*. **O RIR/1999 foi integralmente revogado pelo Decreto nº 9.580/2018 (RIR/2018).** O dispositivo correspondente, com o mesmo conteúdo, é o **art. 714, § 1º, do RIR/2018**, transcrito na seção 1.2 deste documento. A remissão deve ser lida como feita ao art. 714, § 1º, do RIR/2018 (a Lei de Introdução às Normas do Direito Brasileiro e a técnica de consolidação do próprio RIR/2018 asseguram a continuidade normativa), mas o texto literal da IN ainda cita o RIR/1999.

### 3.5 Demais artigos da IN SRF 459/2004 (alíquota e não exigência)
...
> **II** - pessoas jurídicas optantes pelo Regime Especial Unificado de Arrecadação de Tributos e Contribuições devidos pelas Microempresas e Empresas de Pequeno Porte (Simples Nacional), de que trata o art. 12 da Lei Complementar nº 123, de 14 de dezembro de 2006, em relação às suas receitas próprias. *(NR) (Redação dada ao inciso pela Instrução Normativa RFB nº 765, de 02.08.2007, DOU 09.08.2007)*
...
Base legal de fundo: art. 31 da Lei nº 8.212/1991 (<https://www.planalto.gov.br/ccivil_03/leis/l8212cons.htm>) e art. 219 do Decreto nº 3.048/1999 (Regulamento da Previdência Social).

### 4.1 Conceitos — arts. 108 e 109

Capítulo VIII — *Da cessão de mão de obra e da empreitada*; Seção I — *Dos conceitos*.
...
### 4.3 Art. 111 — serviços sujeitos por CESSÃO DE MÃO DE OBRA **OU** EMPREITADA (6 incisos)
...
### 4.4 Art. 112 — serviços sujeitos SOMENTE por CESSÃO DE MÃO DE OBRA (24 incisos)
...
### 4.5 Art. 113 — as listas são EXAUSTIVAS
...
**Consequência prática para a classificação:** se um subitem da LC 116/2003 não corresponder a nenhum dos 6 incisos do art. 111 nem aos 24 incisos do art. 112, **não há retenção de INSS pela natureza da atividade** — e essa conclusão é normativamente segura, porque o art. 113 fecha a lista. A ressalva a fazer é sempre a mesma: o que importa é o serviço concretamente contratado, não o subitem da nota.

### 4.6 Art. 114 — casos NÃO sujeitos à retenção (7 incisos) — redação da IN RFB 2.289/2025

Seção IV — *Dos casos não sujeitos à retenção*.

> *(Redação do caput dada pela Instrução Normativa RFB Nº 2.289 DE 30/10/2025)*
>
...
>
> **§ 2º** Os órgãos públicos da administração direta, autarquias e fundações de direito público que contratarem serviços de construção civil mediante cessão de mão de obra ou empreitada parcial são obrigados a efetuar a retenção prevista no art. 110. (Decreto nº 3.048, de 1999, art. 221-A, parágrafo único) *(Redação do parágrafo dada pela Instrução Normativa RFB Nº 2.289 DE 30/10/2025)*

### 4.7 Art. 115 — dispensa da retenção (3 incisos)

Seção V — *Da dispensa da retenção*.
...
> ⚠️ Note que a lista do § 3º é **exemplificativa** ("dentre outros"), ao contrário das listas dos arts. 111 e 112, que o art. 113 declara exaustivas.

### 4.8 Art. 116 — base de cálculo (materiais e equipamentos)

Seção VI — *Da apuração da base de cálculo da retenção*.
...
## 5. LC 116/2003, art. 3º — local onde o ISS é devido

Confiança: **ALTA** — transcrito do texto consolidado do Planalto (fonte F).

### 5.1 Caput (regra geral)

**Redação vigente (LC 157/2016):**
...
**Redação original (superada), mantida pelo Planalto para histórico:**
...
Conceito de estabelecimento prestador (art. 4º):

> **Art. 4º** Considera-se estabelecimento prestador o local onde o contribuinte desenvolva a atividade de prestar serviços, de modo permanente ou temporário, e que configure unidade econômica ou profissional, sendo irrelevantes para caracterizá-lo as denominações de sede, filial, agência, posto de atendimento, sucursal, escritório de representação ou contato ou quaisquer outras que venham a ser utilizadas.

### 5.2 Incisos I a XXV (todos, com as redações vigentes)
...
>
> **III** – da execução da obra, no caso dos serviços descritos nos **subitens 7.02, 7.19 e 14.14** da lista anexa; *(Redação dada pela Lei Complementar nº 218, de 2025)*
> *Redação anterior (superada): "III – da execução da obra, no caso dos serviços descritos no subitem 7.02 e 7.19 da lista anexa;"*
>
...
> *Redação anterior (superada): "XII – do florestamento, reflorestamento, semeadura, adubação e congêneres, no caso dos serviços descritos no subitem 7.16 da lista anexa;"*
> ⚠️ **A redação vigente do inciso XII deixou de citar o número do subitem.** Ela descreve as atividades, que são exatamente as do subitem 7.16 na redação também dada pela LC 157/2016. A correspondência é textual, não por remissão explícita.
>
...
> *Redação anterior (superada): "XVI – dos bens ou do domicílio das pessoas vigiados, segurados ou monitorados, no caso dos serviços descritos no subitem 11.02 da lista anexa;"*
>
...
> *Redação anterior (superada): "XIX – do Município onde está sendo executado o transporte, no caso dos serviços descritos pelo subitem 16.01 da lista anexa;"*
>
...
> *Redação anterior (superada): "XXV - do domicílio do tomador dos serviços dos subitens 10.04 e 15.09. (Incluído pela Lei Complementar nº 157, de 2016)"*
> ⚠️ **O subitem 10.04 saiu da lista de exceções.** Com a LC 175/2020, o agenciamento/corretagem de leasing, franquia e factoring (10.04) voltou à regra geral do caput (estabelecimento do prestador).

### 5.3 §§ 1º a 4º do art. 3º (regras especiais de local)
...
>
> **§ 4º** Na hipótese de descumprimento do disposto no caput ou no § 1º, ambos do art. 8º-A desta Lei Complementar, o imposto será devido no local do estabelecimento do tomador ou intermediário do serviço ou, na falta de estabelecimento, onde ele estiver domiciliado. *(Incluído pela Lei Complementar nº 157, de 2016)*

### 5.4 §§ 5º a 12 — quem é o "tomador" nos incisos XXIII, XXIV e XXV
...
### 5.5 Mapa rápido subitem → inciso do art. 3º

Todos os subitens NÃO listados abaixo seguem a **regra geral do caput** (estabelecimento do prestador).

| Subitem(ns) | Dispositivo | Local devido |
|---|---|---|
| — (serviço do exterior, art. 1º, § 1º) | art. 3º, I | estabelecimento/domicílio do tomador ou intermediário |
| 3.04 | art. 3º, § 1º | cada Município com extensão de ferrovia, rodovia, postes, cabos, dutos e condutos |
| 3.05 | art. 3º, II | local da instalação das estruturas |
| 4.22, 4.23 | art. 3º, XXIII (+ §§ 5º a 7º) | domicílio do tomador (pessoa física beneficiária) |
| 5.09 | art. 3º, XXIII (+ § 5º) | domicílio do tomador |
| 7.02 | art. 3º, III (LC 218/2025) | local da execução da obra |
| 7.04 | art. 3º, IV | local da demolição |
| 7.05 | art. 3º, V | local das edificações, estradas, pontes, portos e congêneres |
| 7.09 | art. 3º, VI | local da execução |
| 7.10 | art. 3º, VII | local da execução |
| 7.11 | art. 3º, VIII | local da execução |
| 7.12 | art. 3º, IX | local do controle e tratamento |
| 7.16 | art. 3º, XII (correspondência textual — ver ⚠️ em 5.2) | local do florestamento/reflorestamento etc. |
| 7.17 | art. 3º, XIII | local da execução |
| 7.18 | art. 3º, XIV | local da limpeza e dragagem |
| 7.19 | art. 3º, III (LC 218/2025) | local da execução da obra |
| 11.01 | art. 3º, XV | onde o bem estiver guardado ou estacionado |
| 11.02 | art. 3º, XVI | local dos bens, semoventes ou domicílio das pessoas vigiados/segurados/monitorados |
| 11.04 | art. 3º, XVII | local do armazenamento, depósito, carga, descarga, arrumação e guarda |
| 12.01 a 12.12 e 12.14 a 12.17 (**todo o item 12 exceto 12.13**) | art. 3º, XVIII | local da execução dos serviços de diversão/lazer/entretenimento |
| 12.13 | — (regra geral) | estabelecimento do prestador |
| 14.14 | art. 3º, III (LC 218/2025) | local da execução da obra |
| 15.01 | art. 3º, XXIV (+ §§ 8º a 11) | domicílio do tomador |
| 15.09 | art. 3º, XXV (LC 175/2020) (+ § 12) | domicílio do tomador (arrendatário) |
| 16.01 e 16.02 (**todo o item 16**) | art. 3º, XIX (LC 157/2016) | Município onde está sendo executado o transporte |
| 17.05 | art. 3º, XX | estabelecimento/domicílio do tomador da mão de obra |
| 17.10 | art. 3º, XXI | local da feira, exposição, congresso ou congênere |
| 20.01, 20.02, 20.03 (**todo o item 20**) | art. 3º, XXII | porto, aeroporto, ferroporto, terminal rodoviário, ferroviário ou metroviário |
| 20.01 | art. 3º, § 3º | exceção à regra dos serviços em águas marítimas |
| 22.01 | art. 3º, § 2º | cada Município com extensão de rodovia explorada |
| **10.04** | ❌ **NÃO mais excepcionado** — ver ⚠️ no inciso XXV | estabelecimento do prestador (regra geral, desde a LC 175/2020) |

---

## 6. LC 116/2003, art. 6º — responsabilidade tributária / substituição do ISS
...
>
> *Redação anterior (superada): "II – a pessoa jurídica, ainda que imune ou isenta, tomadora ou intermediária dos serviços descritos nos subitens 3.05, 7.02, 7.04, 7.05, 7.09, 7.10, 7.12, 7.14, 7.15, 7.16, 7.17, 7.19, 11.02, 17.05 e 17.10 da lista anexa."* — a LC 183/2021 removeu da lista os subitens 7.14 e 7.15, que estavam **vetados** desde a origem.
>
...
>
> **§ 3º** *(Revogado). (Redação dada pela Lei Complementar nº 175, de 2020)*
>
...
**Leitura prática:** o art. 6º **não institui** a retenção do ISS — ele **autoriza** cada Município a fazê-lo por lei própria. O § 2º, II, porém, é norma nacional de eficácia direta: para os **13 subitens ali listados** (3.05, 7.02, 7.04, 7.05, 7.09, 7.10, 7.12, 7.16, 7.17, 7.19, 11.02, 17.05 e 17.10), o tomador pessoa jurídica é responsável independentemente de lei municipal. Fora desses casos, a resposta correta para o campo `iss_responsavel` continua sendo **"Depende da legislação municipal"**.

---

## ⚠️ Leia antes de usar

### 1. Níveis de confiança por fonte

| Conteúdo | Confiança | Justificativa |
|---|---|---|
| Lista de serviços anexa à LC 116/2003 (`lc116-lista-completa.json`) | **ALTA** | Texto consolidado oficial do Planalto, conferido item a item. 40 itens, 205 subitens, sem lacunas na numeração. |
| LC 116/2003, arts. 3º, 4º e 6º (seções 5 e 6) | **ALTA** | Planalto, texto consolidado com todas as redações históricas visíveis. |
...
| Norma citada por fontes secundárias | Situação real | Onde isso importa |
|---|---|---|
| **IN RFB nº 971/2009**, arts. 117-120 e 149 (retenção previdenciária) | **REVOGADA.** Substituída pela **IN RFB nº 2.110/2022**, arts. 108 a 116. A numeração dos artigos mudou. | Toda a seção 4 |
| **Lei 10.833/2003, art. 31, § 3º — dispensa de R$ 5.000,00** | **SUPERADA.** A Lei nº 13.137/2015 substituiu o § 3º pelo limite de **R$ 10,00** e revogou o § 4º (soma dos pagamentos do mês). | Seção 3.2 — 🚨 **e corrija a nota do subitem 17.14 em `data/retencoes.json`, que reproduz o valor errado** |
| **IN SRF 459/2004, art. 1º, §§ 3º, 4º e 5º** | **Texto não atualizado pela RFB.** A IN continua repetindo o limite revogado de R$ 5.000,00. A IN em si permanece vigente; apenas esses parágrafos foram superados pela lei posterior. | Seção 3.4 |
| **IN SRF 459/2004, art. 1º, § 2º, IV — remissão ao "art. 647 do RIR/1999"** | O **RIR/1999 (Decreto 3.000/1999) foi revogado** pelo Decreto 9.580/2018. O dispositivo correspondente é o **art. 714, § 1º, do RIR/2018**. | Seção 3.4 |
| **LC 116/2003, art. 3º, XXV — "subitens 10.04 e 15.09"** | **Redação superada.** A LC 175/2020 retirou o subitem **10.04**, que voltou à regra geral do caput. Muitos sites ainda listam 10.04 como exceção. | Seção 5.2 e 5.5 |
| **LC 116/2003, art. 3º, III — "subitens 7.02 e 7.19"** | **Redação superada.** A **LC nº 218, de 2025**, incluiu o **subitem 14.14** (guincho intramunicipal, guindaste e içamento) na regra do local da execução da obra. **CONFIRMADO** no texto consolidado do Planalto. | Seção 5.2 e 5.5 |
| **LC 116/2003, art. 6º, § 2º, II — lista com 7.14 e 7.15** | **Redação superada.** A LC 183/2021 removeu esses dois subitens (que sempre estiveram vetados) e excepcionou o subitem 11.05. | Seção 6 |
...
3. **Reforma tributária (LC 214/2025).** O cabeçalho da LC 116/2003 no Planalto já traz "(Vide Lei Complementar nº 214, de 2025) Produção de efeitos", e o art. 8º-B prevê a redução escalonada das alíquotas do ISS entre 2029 e 2032, com extinção do imposto ao final. O art. 31, § 1º, da Lei 10.833/2003 também traz remissão à LC 214/2025 com produção de efeitos futura. **Nada disso altera as regras vigentes hoje**, mas a ferramenta deve prever que este conteúdo tem prazo de validade e precisará de revisão a cada etapa da transição.

4. **Enquadramento por assimilação no IRRF/CSRF.** A lista do art. 714, § 1º, do RIR/2018 é **taxativa**, mas usa nomes de profissões/atividades, enquanto a LC 116/2003 usa descrições de serviços. **As duas listas não se correspondem uma a uma.** Vários subitens da LC 116 só se enquadram por assimilação (ex.: "análise e desenvolvimento de sistemas" → "programação"/"análises técnicas"/"elaboração de projetos"). Toda classificação feita por assimilação deve:
   - ser marcada explicitamente como tal na nota do item;
   - remeter à análise do objeto concreto do contrato;
   - ser revisada por contador antes da publicação.

   Não existe — e não encontrei — nenhuma tabela oficial de correspondência LC 116 ↔ art. 714 do RIR/2018. Qualquer mapeamento é interpretação.

5. **Subitens que reúnem serviços de naturezas diferentes.** Vários subitens da LC 116 agregam prestações com tratamento tributário distinto dentro do mesmo código (exemplos já identificados: 4.03, 7.05, 8.02, 11.02, 16.02). Nesses casos, **uma única resposta "sim/não" por subitem é necessariamente uma simplificação**. Recomendo que a ferramenta exiba, para esses itens, a ressalva de análise caso a caso de forma destacada — como a amostra em `data/retencoes.json` já faz no campo `observacoes`.

6. **Súmula Vinculante 31 do STF** ("é inconstitucional a incidência do Imposto sobre Serviços de Qualquer Natureza – ISS sobre operações de locação de bens móveis") não foi verificada nesta pesquisa contra a fonte primária do STF; consta da amostra anterior. Relevante sobretudo para os subitens 3.04, 3.05 e 15.03. **Confirmar em <https://portal.stf.jus.br> antes de publicar.**

### 5. Uma advertência final sobre o produto

Este material é base normativa, não parecer. A resposta correta para qualquer consulta concreta depende do **objeto do contrato**, do **regime tributário do prestador** (o Simples Nacional afasta a CSRF e altera o IRRF), da **natureza do tomador** (privado / administração pública federal / estadual / municipal) e da **legislação municipal** no caso do ISS. A ferramenta deve dizer isso ao usuário de forma visível, e não apenas no rodapé.
